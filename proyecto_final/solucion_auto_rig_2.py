...
def create_fk_controller(target_joint):
    ...
    new_controller_shape_name = new_controller_name + "Shape"
    ...
    print("Making FK controller pretty")
    cmds.setAttr(new_controller_shape_name + line_width_attribute, 5)
    cmds.setAttr(new_controller_shape_name + display_override_attribute, 1)
    cmds.setAttr(new_controller_shape_name + color_override_attribute, 1)
    cmds.setAttr(new_controller_shape_name + colors_attribute, 1,0,0.8)
...
def create_fk_controllers_main(*args):
    ...
    create_controller_hierarchy(target_joints)
...
def make_pretty_ik_controllers(ik_controller, pole_vector_controller):
    """
    Changes color and width of controllers
    """

    ik_controller_shape_name = ik_controller + "Shape"
    pole_vector_controller_shape_name = pole_vector_controller + "Shape"
    ...
    cmds.setAttr(ik_controller_shape_name + line_width_attribute, 5)
    cmds.setAttr(ik_controller_shape_name + display_override_attribute, 1)
    cmds.setAttr(ik_controller_shape_name + color_override_attribute, 1)
    cmds.setAttr(ik_controller_shape_name + colors_attribute, 1,0.9,0)

    cmds.setAttr(pole_vector_controller_shape_name + display_override_attribute, 1)
    cmds.setAttr(pole_vector_controller_shape_name + color_override_attribute, 1)
    cmds.setAttr(pole_vector_controller_shape_name + colors_attribute, 1,0.9,0)
...
def create_ik_rig(*args):
    ...
    print("Making pretty IK controllers")
    make_pretty_ik_controllers(ik_controller, pole_vector_controller)
